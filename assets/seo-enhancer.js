// ✅ MaxClickEmpire SEO Enhancer v3.1 (function () { const waitForDom = (callback) => { if (document.readyState === "loading") { document.addEventListener("DOMContentLoaded", callback); } else { callback(); } };

waitForDom(() => { const pathSlug = location.pathname.replace(/^//, '').replace(/.html$/, ''); const skip = ["about", "contact", "privacy-policy", "terms"]; if (skip.includes(pathSlug)) return; // Skip static pages
